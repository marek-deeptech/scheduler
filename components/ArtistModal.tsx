...
interface Props {
  ...
  allActors?: SubstituteActor[]   // all Cast actors for substitute picker
  presetTeamId?: string
  onClose: () => void
  onSaved: () => void
}
...
export default function ArtistModal({ artist, productions, allActors = [], presetTeamId, onClose, onSaved }: Props) {
  const { t } = useLanguage()
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90dvh] flex flex-col">
        {/* Header */}
